...
final class Version0 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', creator_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', image_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, publicity VARCHAR(255) NOT NULL, INDEX IDX_CBE5A33161220EA6 (creator_id), UNIQUE INDEX UNIQ_CBE5A3313DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A33161220EA6 FOREIGN KEY (creator_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP FOREIGN KEY FK_CBE5A33161220EA6');
